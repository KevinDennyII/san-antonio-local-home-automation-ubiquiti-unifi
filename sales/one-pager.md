# One-Pager — Private Estate Network

**For:** Realtor leave-behind and listing / buyer consultations  
**Brand:** [BRAND NAME] · San Antonio luxury homes
...
| Offer | Price |
|-------|-------|
| **Private Network & Local Smart Home pilot** | **~$5,000** ($4k–$5.5k) — we buy the gear, handle wiring, and do all setup |

Pilot = UniFi (UDM Pro) migration + segmented Wi‑Fi + Home Assistant + local voice (up to 20 devices). Cameras, doorbell, landline, and extra storage are still being scoped — not in the pilot price yet. See the pilot sheet for details.

## Later — Estate packages
...
Warm intro to **[BRAND / YOUR NAME]** → quick walkthrough → ~$5,000 pilot.

[PHONE] · [EMAIL] · Referred by [REALTOR NAME]
